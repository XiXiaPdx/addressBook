...
Address.prototype.fullAddress = function() {
  return this.type + " address: " + this.street + ", " + this.city + ", " + this.state;
}
...
$(document).ready(function() {
  $("#add-address").click(function() {
    $("#new-addresses").append('<div class="new-address" id="additional-address">' +
                                 ...
                                 '<select class="form-control" id="address-type"><option>Home</option><option>Work</option><option>Vacation Home</option><option>Secret Lab</option><option>Bunker</option></select>'+
